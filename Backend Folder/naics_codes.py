"""
Full official 2022 NAICS 6-digit code/title list (983 industries),
sourced from the U.S. Census Bureau's own NAICS classification data
(a public-domain government classification system, not copyrighted).
This mirrors frontend/index.html's NAICS_CODES array so the /api/naics/search
fallback endpoint stays consistent with the client-side picker.
"""
...
def search_naics(query: str, limit: int = 50):
